...
class AdminPage(BasePage):
    ...
    def to_product(self, browser):
        ...
        WebDriverWait(self.browser, 10).until((EC.element_to_be_clickable((By.XPATH, '//*[@id="collapse-1"]/li[2]/a')))).click()
    ...
    def description_new_product(self):
        WebDriverWait(self.browser, 10).until((EC.element_to_be_clickable((By.ID, 'menu-catalog')))).click()
        WebDriverWait(self.browser, 10).until((EC.element_to_be_clickable((By.XPATH, '//*[@id="collapse-1"]/li[2]/a')))).click()
        WebDriverWait(self.browser, 10).until((EC.element_to_be_clickable((By.XPATH, '//*[@id="content"]/div[1]/div/div/a')))).click()
        WebDriverWait(self.browser, 10).until((EC.element_to_be_clickable((By.CLASS_NAME, 'cke_notification_close')))).click()
        ...
        WebDriverWait(self.browser, 10).until((EC.element_to_be_clickable((By.XPATH, '//*[@id="form-product"]/ul/li[2]/a')))).click()
        ...
        WebDriverWait(self.browser, 10).until((EC.element_to_be_clickable((By.XPATH, '//*[@id="form-product"]/ul/li[3]/a')))).click()
        WebDriverWait(self.browser, 10).until((EC.element_to_be_clickable((By.XPATH, '//*[@id="form-product"]/ul/li[11]/a')))).click()
        self.browser.find_element(*self.SEO).send_keys(seo)
        WebDriverWait(self.browser, 10).until((EC.element_to_be_clickable((By.XPATH, '//*[@id="content"]/div[1]/div/div/button')))).click()
